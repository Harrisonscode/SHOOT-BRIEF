...
import { LayoutDashboard, Plus, Calendar, Image as ImageIcon, CreditCard, Settings, LogOut, X, Inbox, Package, Star, MoreHorizontal, FileText, Receipt, Zap } from "lucide-react";
